...
\addbibresource{backmatter/REAL_bibliography.bib}
...
%%----------------------------------------
% \title{$<$ Towards Developing Time Aligned Music Data visualization $>$}
\title{LayerIt: Towards a Time-Aligned Framework for Composable Music Visualization Layers}
\author{Fernando Azeredo}
...
\supervisor{Supervisor}{Prof.\ António S\'a Pinto}
...
%%--------------------------------------------------------------------------------
% COMENTEI ESTES FORA PARA APENAS VER UM CAP. 
% Descomentar esta secção para ver as primeiras páginas. E comentar o \includeonly{}
% !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
\begin{Prolog}
