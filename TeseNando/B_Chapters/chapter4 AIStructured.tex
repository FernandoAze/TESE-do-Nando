...
%GETTING THE MEI SCORE
% A MEI score can be obtained from various sources. The easiest way to do this is to download a score in .musicxml  and then using verovio online editor, or musescore to then convert it to .mei. 
