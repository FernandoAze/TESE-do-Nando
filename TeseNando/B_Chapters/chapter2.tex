...
A spectogram can show it's frequency linearly, logarithmically, weighted and/or normalized. 

@khodzhaevPracticalGuideSpectrogram; @valleVisualDisplayRetrieval
