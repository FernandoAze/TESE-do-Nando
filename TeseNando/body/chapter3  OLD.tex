...
The codebase integrates BeatThis the as-of-now SOTA BT algorithm. Through it's implementation we demonstrate how a given BT model can be integrated to our system in order to produce beat data visualizations.  
