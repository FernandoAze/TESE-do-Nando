...
\ac{MIR} is the field of research that focuses on the development of algorithms and systems to analyze, retrieve, and organize music data. \ac{MIR} bridges a wide range of disciplines, including: musicology, signal processing, machine learning, and human-computer interaction. 
...
The \textbf{Piano-Roll} is a staple on any \ac{DAW} as a visual and interactive tool to write and edit musical events in the form of \ac{MIDI} notes and attributes (such as velocity and other expressive controls).

\textbf{MusicXML} refers to the \ac{XML}-based language to transcribe score music into the digital domain. There are multiple sub-variants of the MusicXML format for specific applications, however all share an \ac{XML} based language underneath. 
...
\begin{itemize}
    ...
    \item \textbf{.mei}  - The "Music Encoding Initiative" (\ac{MEI}). \ac{XML} based.
\end{itemize}
...
Important to note that both software solutions are free and open-source based. These are important features, since they allow for users to easily access them, but also for researchers and experts to modify them and thus, contribute to the development of SV and new SV-like tools.
...
\\
\noindent Besides online and offline modes of score matching, the alignment in itself can be done to various levels of the performance or score these include:
\begin{itemize}
    \item Note-level
    \item Beat-level
    \item Segment-level
