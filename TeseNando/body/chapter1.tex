...
\begin{itemize}
    ...
    \item \textbf{RQ3}: How can score-aligned visualizations support qualitative inspection of beat-tracking outputs and annotation data by relating estimates, activations, audio representations, and notated events on a common time axis in the demonstrated case studies, subject to the limitations of the available score-performance alignment?
\end{itemize}
