...
\begin{figure}[H]
  ...
  \caption{Temporary placeholder for the LayerIt architecture diagram. This figure reflects an earlier implementation and will be replaced by an updated diagram in the final revision.}
